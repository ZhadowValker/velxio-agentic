...
class ESPIDFCompiler:
    ...
    def _resolve_library_components(
        ...
        cmake_content = (
            '# Auto-generated by SoundMind — all user libraries merged into one component.\n'
    ...
    def _create_idf_component(
        ...
        cmake_content = (
            f'# Auto-generated by SoundMind for library: {lib_dir_name}\n'
    ...
    def _merge_flash_image(self, build_dir: Path, is_c3: bool) -> Path:
        ...
        app = build_dir / 'soundmind-sketch.bin'
    ...
    async def compile(self, files: list[dict], board_fqbn: str) -> dict:
        ...
        with tempfile.TemporaryDirectory(prefix='espidf_') as temp_dir:
            ...
            # QEMU's WiFi AP broadcasts "SoundMind-GUEST" on channel 6.
            # We normalize ANY user SSID → "SoundMind-GUEST", enforce channel 6,
