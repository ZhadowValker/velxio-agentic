...
export const INLINE_SVGS: Record<string, InlineEntry> = {
  ...
  'soundmind-capacitor-electrolytic': { component: Capacitor, w: 36, h: 56 },
  'wokwi-inductor': { component: Capacitor, w: 56, h: 36 },
  // Electromechanical
  'soundmind-relay': { component: Relay, w: 96, h: 96 },
  // Optocouplers
  'soundmind-opto-4n25': { component: Opto4N25, w: 80, h: 64 },
  'soundmind-opto-pc817': { component: Opto4N25, w: 80, h: 64 },
  // IC
  'soundmind-motor-driver-l293d': { component: MotorDriverL293D, w: 100, h: 80 },
  ...
  // Logic gates — examples use both `soundmind-logic-gate-*` and `soundmind-logic-*` naming
  'soundmind-logic-gate-and': { component: GateAnd, w: 72, h: 48 },
  'soundmind-logic-gate-or': { component: GateOr, w: 72, h: 48 },
  'soundmind-logic-gate-nand': { component: GateNand, w: 72, h: 48 },
  'soundmind-logic-gate-nor': { component: GateNor, w: 72, h: 48 },
  'soundmind-logic-gate-xor': { component: GateXor, w: 72, h: 48 },
  'soundmind-logic-gate-xnor': { component: GateXnor, w: 72, h: 48 },
  'soundmind-logic-gate-not': { component: GateNot, w: 72, h: 48 },
  'soundmind-logic-and': { component: GateAnd, w: 72, h: 48 },
  'soundmind-logic-or': { component: GateOr, w: 72, h: 48 },
  'soundmind-logic-nand': { component: GateNand, w: 72, h: 48 },
  'soundmind-logic-nor': { component: GateNor, w: 72, h: 48 },
  'soundmind-logic-xor': { component: GateXor, w: 72, h: 48 },
  'soundmind-logic-xnor': { component: GateXnor, w: 72, h: 48 },
  'soundmind-logic-not': { component: GateNot, w: 72, h: 48 },
  // Power
  ...
  // Instruments
  'soundmind-instr-voltmeter': { component: Voltmeter, w: 72, h: 56 },
  'soundmind-instr-ammeter': { component: Ammeter, w: 72, h: 56 },
};
