 ...
 *
 * Tags defined:
 *   soundmind-flip-flop-d   — D-type (Q ← D on rising CLK)
 *   soundmind-flip-flop-t   — T-type (Q toggles when T=1 on rising CLK)
 *   soundmind-flip-flop-jk  — JK (hold/set/reset/toggle on rising CLK)
 *
...
if (!customElements.get('soundmind-flip-flop-d'))
  customElements.define('soundmind-flip-flop-d', DFlipFlopElement);
if (!customElements.get('soundmind-flip-flop-t'))
  customElements.define('soundmind-flip-flop-t', TFlipFlopElement);
if (!customElements.get('soundmind-flip-flop-jk'))
  customElements.define('soundmind-flip-flop-jk', JKFlipFlopElement);
