 ...
 *
 * Implements SVG-rendered logic gate elements for use in the SoundMind simulator.
 * These do NOT exist in wokwi-elements, so we define them here.
 *
 * Tags defined:
 *   soundmind-logic-and  — 2-input AND gate
 *   soundmind-logic-nand — 2-input NAND gate
 *   soundmind-logic-or   — 2-input OR gate
 *   soundmind-logic-nor  — 2-input NOR gate
 *   soundmind-logic-xor  — 2-input XOR gate
 *   soundmind-logic-xnor — 2-input XNOR gate
 *   soundmind-logic-not  — 1-input NOT (inverter)
 *
...
if (!customElements.get('soundmind-logic-and'))
  customElements.define('soundmind-logic-and', AndGateElement);
if (!customElements.get('soundmind-logic-nand'))
  customElements.define('soundmind-logic-nand', NandGateElement);
if (!customElements.get('soundmind-logic-or')) customElements.define('soundmind-logic-or', OrGateElement);
if (!customElements.get('soundmind-logic-nor'))
  customElements.define('soundmind-logic-nor', NorGateElement);
if (!customElements.get('soundmind-logic-xor'))
  customElements.define('soundmind-logic-xor', XorGateElement);
if (!customElements.get('soundmind-logic-xnor'))
  customElements.define('soundmind-logic-xnor', XnorGateElement);
if (!customElements.get('soundmind-logic-not'))
  customElements.define('soundmind-logic-not', NotGateElement);
...
if (!customElements.get('soundmind-logic-and-3'))
  customElements.define('soundmind-logic-and-3', And3Gate);
if (!customElements.get('soundmind-logic-or-3')) customElements.define('soundmind-logic-or-3', Or3Gate);
if (!customElements.get('soundmind-logic-nand-3'))
  customElements.define('soundmind-logic-nand-3', Nand3Gate);
if (!customElements.get('soundmind-logic-nor-3'))
  customElements.define('soundmind-logic-nor-3', Nor3Gate);
if (!customElements.get('soundmind-logic-and-4'))
  customElements.define('soundmind-logic-and-4', And4Gate);
if (!customElements.get('soundmind-logic-or-4')) customElements.define('soundmind-logic-or-4', Or4Gate);
if (!customElements.get('soundmind-logic-nand-4'))
  customElements.define('soundmind-logic-nand-4', Nand4Gate);
if (!customElements.get('soundmind-logic-nor-4'))
  customElements.define('soundmind-logic-nor-4', Nor4Gate);
