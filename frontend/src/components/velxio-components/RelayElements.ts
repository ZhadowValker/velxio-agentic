 ...
 *
 * Tag defined:
 *   soundmind-relay — 5-pin SPDT relay (COIL+, COIL-, COM, NO, NC)
 *
...
if (!customElements.get('soundmind-relay')) customElements.define('soundmind-relay', RelayElement);
...
if (!customElements.get('soundmind-opto-4n25')) customElements.define('soundmind-opto-4n25', Opto4N25);
if (!customElements.get('soundmind-opto-pc817')) customElements.define('soundmind-opto-pc817', OptoPC817);
...
if (!customElements.get('soundmind-motor-driver-l293d')) {
  customElements.define('soundmind-motor-driver-l293d', L293DElement);
}
