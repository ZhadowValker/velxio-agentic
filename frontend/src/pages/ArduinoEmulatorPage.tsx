...
const FAQ_ITEMS = [
  ...
  {
    q: "How accurate is SoundMind's Arduino emulation?",
    a: 'SoundMind uses avr8js, which provides cycle-accurate AVR8 instruction emulation. Every AVR opcode is faithfully emulated at 16 MHz, making it reliable for developing and debugging real firmware before flashing to hardware.',
  },
  {
    q: 'Which Arduino boards can SoundMind emulate?',
  ...
  {
    q: 'How is SoundMind different from Wokwi?',
    a: 'SoundMind is fully self-hosted and open-source under GNU AGPLv3. It uses the same avr8js emulation library as Wokwi but runs entirely on your own machine — no cloud dependency, no registration, no subscription.',
  },
];
...
const JSON_LD: object[] = [
  {
    ...
    name: 'SoundMind Arduino Emulator',
    ...
    url: 'https://soundmind.dev/arduino-emulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'SoundMind', item: 'https://soundmind.dev/' },
      {
        ...
        item: 'https://soundmind.dev/arduino-emulator',
      },
    ],
  },
];
      ...
      <main>
        ...
        <section className="seo-hero">
          ...
          <p className="subtitle">
            SoundMind is a cycle-accurate Arduino emulator running entirely in your browser. Every AVR
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            SoundMind uses <strong style={{ color: '#e6edf3' }}>avr8js</strong> for AVR8 and{' '}
