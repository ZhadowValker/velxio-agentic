...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Yes. SoundMind is 100% free and open-source. Simulate ESP32-S3 code in your browser with real Xtensa LX7 emulation via QEMU — no cloud, no subscription.',
  },
  {
    q: 'Which ESP32-S3 boards are supported?',
    a: 'SoundMind supports ESP32-S3 DevKitC-1, Seeed XIAO ESP32-S3, and Arduino Nano ESP32 (which uses the ESP32-S3 chip).',
  },
  {
    q: 'Can I use Arduino libraries with ESP32-S3?',
    a: 'Yes. SoundMind compiles your sketch with the official ESP32 Arduino core. Install any library from the Arduino Library Manager and use it in your ESP32-S3 project.',
  },
  {
...
const JSON_LD: object[] = [
  {
    ...
    name: 'SoundMind — Free ESP32-S3 Simulator',
    ...
    url: 'https://soundmind.dev/esp32-s3-simulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'SoundMind', item: 'https://soundmind.dev/' },
      {
        ...
        item: 'https://soundmind.dev/esp32-s3-simulator',
      },
    ],
  },
];
    ...
    <div className="seo-page">
      ...
      <main>
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            SoundMind emulates three ESP32-S3 boards. Each runs the official ESP32 Arduino core
