...
const FAQ_ITEMS = [
  {
    ...
    a: 'Yes. SoundMind is completely free and open-source (GNU AGPLv3). Simulate ESP32 code in your browser or self-host the entire platform with one Docker command — no account, no payment.',
  },
  {
    q: 'How does the ESP32 emulation work?',
    a: 'SoundMind uses QEMU (lcgamboa fork) to emulate the Xtensa LX6 CPU at 240 MHz. Your Arduino sketch is compiled with the official ESP32 Arduino core and the resulting firmware runs on the emulated hardware — same as real silicon.',
  },
  {
    q: 'Which ESP32 boards are supported?',
    a: 'SoundMind supports ESP32 DevKit V1, ESP32 DevKit C V4, ESP32-CAM, Arduino Nano ESP32, ESP32-S3 DevKitC, XIAO ESP32-S3, ESP32-C3 DevKit, XIAO ESP32-C3, and ESP32-C3 SuperMini.',
  },
  {
...
const JSON_LD: object[] = [
  {
    ...
    name: 'SoundMind — Free ESP32 Simulator & Emulator',
    ...
    url: 'https://soundmind.dev/esp32-simulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'SoundMind', item: 'https://soundmind.dev/' },
      {
        ...
        item: 'https://soundmind.dev/esp32-simulator',
      },
    ],
  },
];
    ...
    <div className="seo-page">
      ...
      <main>
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            SoundMind emulates the full ESP32 family — Xtensa LX6 (ESP32), Xtensa LX7 (ESP32-S3), and
