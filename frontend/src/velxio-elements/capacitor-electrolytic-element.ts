/**
 * <soundmind-capacitor-electrolytic> — polarized aluminum-can capacitor.
 *
...
if (!customElements.get('soundmind-capacitor-electrolytic')) {
  customElements.define('soundmind-capacitor-electrolytic', CapacitorElectrolyticElement);
}
