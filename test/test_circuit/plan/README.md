...
- `phase_5_avr_integration.md` — integración con avr8js (estilo SoundMind)
...
- **`phase_8_soundmind_implementation.md`** — **plan de implementación en SoundMind** (definitivo): componentes nuevos (genéricos + reales), instrumentos, fases 8.1–8.6
- **`phase_9_component_catalog_expansion.md`** — expansión del catálogo: XNOR, SPICE mappers para las gates existentes, PNP/P-MOSFET, op-amps reales, reguladores, fuentes (complementa fase 8 con los huecos detectados en `autosearch/05_soundmind_component_inventory.md`)
