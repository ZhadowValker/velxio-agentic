...
SoundMind dispara listeners de pines al escribir PORTB/C/D y enruta al PinManager. Los ADC se leen cuando el sketch hace `analogRead`.
...
- Instancia `CPU`, `AVRIOPort`, `AVRADC`, `AVRTimer` igual que SoundMind
...
- `fixtures/blink.hex` — del fixture existente de SoundMind
